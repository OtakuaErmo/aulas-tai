                ...
                <div class="card-body">
                    ...
                    <body>
                        <form action="{{action('CursoController@search')}}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-6">
                                    <input type="text" class="form-control" placeholder="Pesquisar curso" name="nome" />
                                </div>
                                <div class="col-6">
                                    <button type="submit" class="btn btn-warning btn-outline-dark"> <i class="fa fa-search"></i> Buscar</button>

                                    <a href="{{ url('/curso/create')}}" class="btn btn-danger btn-outline-light"> <i class="fa fa-plus-circle"></i>  Cadastrar</a>
                                </div>
                            </div>
                        </form>
                        <br>
